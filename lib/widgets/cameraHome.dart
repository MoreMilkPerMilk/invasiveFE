                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Padding(
                                                ...
                                                child: Text(
                                                  (path == "")
                                                      ? "Try and frame the plants flowers or leaves as the subject of the capture. "
                                                      : label,
                                                  style: TextStyle(
                                                      color: Colors.white),
                                                    ...
                                                    Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                .all(8),
                                                        child: Text(
                                                            "The model wasn't confident it detected an invasive species. You can manually report it if you are sure "
                                                            "the captured species is a weed.",
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors
