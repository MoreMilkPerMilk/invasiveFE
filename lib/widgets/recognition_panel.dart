...
class Recognition extends StatefulWidget {
  Recognition({required Key key, required this.ready}) : super(key: key);
...
// to track the subscription state during the lifecycle of the component
...
class _RecognitionState extends State<Recognition> {
  ...
  TfliteService _tensorflowService = TfliteService();
